                    ...
                    <div class="card shadow-sm border border-dashed border-dark rounded">
                        <div class="card-header border-0 pt-6">
                            <div class="card-title m-0">
                                <h3 class="fw-bolder m-0 text-gray-900">List Ruangan</h3>
                            </div>
                            <div class="card-toolbar">
                                <a type="button" class="btn btn-sm btn-primary m-0" data-bs-toggle="modal" data-bs-target="#form_create" title="Tambah Ruangan">
                            ...
                            <div class="border border-dashed rounded p-5 mb-5" style="border-color: #b5b5c3 !important;">
                                ...
                                <div class="row g-5">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <label class="form-label fw-bold mb-2">Gedung:</label>
                                        <select class="form-select form-select-sm" data-control="select2"
                                            data-placeholder="Semua Gedung" data-allow-clear="true" data-filter="gedung"
                                            id="filter-gedung">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <label class="form-label fw-bold mb-2">Lantai:</label>
                                        <select class="form-select form-select-sm" data-control="select2"
                                            data-placeholder="Semua Lantai" data-allow-clear="true" data-filter="lantai"
                                            id="filter-lantai" disabled>
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="example">
                                    <thead>
                                        <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-150px">Nama Ruangan</th>
                                                <th class="min-w-125px">Fungsi</th>
                                                <th class="min-w-125px">Lantai</th>
                                                <th class="min-w-125px">Gedung</th>
                                            </tr>
                                        </thead>
...
@section('js')
    ...
    @include('admin.ruangan.script.index')
    @include('admin.ruangan.script.create')
    @include('admin.ruangan.script.edit')
    @include('admin.ruangan.script.show')
@endsection
