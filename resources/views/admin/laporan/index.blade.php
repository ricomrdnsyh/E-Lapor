            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack flex-wrap gap-3">
                    <div class="page-title d-flex flex-column me-3">
                        <h1 class="text-dark fw-bold fs-3 mb-1">Manajemen Laporan</h1>
                        <span class="text-muted fw-semibold fs-7">Kelola data laporan yang masuk ke sistem</span>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card card-flush h-md-100 shadow-sm border-dark rounded border border-dashed">
                                ...
                                <div class="card-header pt-6">
                                    <div class="card-title">
                                        <h3 class="card-label fw-bold fs-3 mb-1">List Laporan</h3>
                                    </div>
                                </div>
