                            ...
                            <div class="card-body pt-4 pb-7">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea id="show_deskripsi_laporan" rows="3" class="form-control form-control-sm fs-sm-8 fs-lg-6 text-dark"
                                            disabled></textarea>
                                    </div>
                                    <div class="col-12">
                                        <label class="d-flex align-items-center fs-sm-8 fs-lg-6 fw-bolder mb-1">
                                        ...
                                        <div id="show_lampiran_file" class="text-gray-600 fs-8">-</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card card-flush shadow-sm border border-gray-300 rounded-4 mb-0">
                            <div class="card-header py-3 bg-light-primary border-bottom border-gray-200 rounded-top-4">
                                <div class="card-title d-flex align-items-center gap-2 mb-0">
                                    <span class="badge badge-primary p-2">
                                        <i class="ki-duotone ki-information fs-4 text-white">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                                        </i>
                                    </span>
                                    <h6 class="fw-bold fs-6 mb-0 text-primary">Informasi Sistem</h6>
                                </div>
                            </div>
                            <div class="card-body pt-4 pb-7">
                                <div class="row g-3">
