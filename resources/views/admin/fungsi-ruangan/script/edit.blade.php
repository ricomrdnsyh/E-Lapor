    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.addEventListener('click', function(e) {
            if (e.target.closest('.btn-edit')) {
                ...
                $.ajax({
                    url: '/admin/fungsi-ruangan/' + id + '/edit',
                    type: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        document.getElementById('edit_nama_fungsi').value = data
                            .nama_fungsi || '';

                        form.action = '/admin/fungsi-ruangan/' + id;
                    ...
                    error: function(xhr) {
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            text: 'Gagal mengambil data fungsi ruangan'
                        });
                    }
                });
            }
