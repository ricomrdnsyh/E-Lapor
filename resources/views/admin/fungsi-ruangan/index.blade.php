...
@section('title', 'List Fungsi Ruangan')
...
@section('content')
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack flex-wrap gap-3">
                    <div class="page-title d-flex flex-column me-3">
                        <h1 class="text-dark fw-bold fs-3 mb-1">Manajemen Fungsi Ruangan</h1>
                        <span class="text-muted fw-semibold fs-7">Kelola data fungsi ruangan yang ada dalam sistem</span>
                    </div>
                    <div class="d-flex w-100 w-sm-auto justify-content-end ms-auto">
                        <a type="button" class="btn btn-sm btn-primary w-100 w-sm-auto text-nowrap" data-bs-toggle="modal"
                            data-bs-target="#form_create" title="Tambah Fungsi Ruangan">
                            <i class="fas fa-plus me-2"></i>Tambah Fungsi Ruangan
                        </a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card card-flush h-md-100 shadow-sm border-dark rounded border border-dashed">
                                <div class="card-header pt-6">
                                    <div class="card-title">
                                        <h3 class="card-label fw-bold fs-3 mb-1">List Fungsi Ruangan</h3>
                                    </div>
                                </div>
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="example">
                                        <thead>
                                            <tr class="text-start text-gray-600 fw-semibold fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-200px">Nama Fungsi</th>
                                            </tr>
                                        </thead>
            ...
            @include('admin.fungsi-ruangan.create')
            @include('admin.fungsi-ruangan.edit')
            @include('admin.fungsi-ruangan.show')
...
@section('js')
    ...
    @include('admin.fungsi-ruangan.script.index')
    @include('admin.fungsi-ruangan.script.create')
    @include('admin.fungsi-ruangan.script.edit')
    @include('admin.fungsi-ruangan.script.show')
@endsection
