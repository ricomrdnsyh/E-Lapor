<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const selectElement = document.getElementById('edit_gedung_id');
        if (selectElement && $) {
            ...
            if (e.target.closest('.btn-edit')) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        document.getElementById('edit_nama_lantai').value = data
                            .nama_lantai || '';

                        setTimeout(function() {
                            const selectEl = document.getElementById(
                                'edit_gedung_id');
                            $(selectEl).val(data.gedung_id).trigger('change');
                        }, 100);
