                    ...
                    <div class="card shadow-sm border border-dashed border-dark rounded">
                        <div class="card-header border-0 pt-6">
                            <div class="card-title m-0">
                                <h3 class="fw-bolder m-0 text-gray-900">List Lantai</h3>
                            </div>
                            <div class="card-toolbar">
                                <a type="button" class="btn btn-sm btn-primary m-0" data-bs-toggle="modal" data-bs-target="#form_create" title="Tambah Lantai">
