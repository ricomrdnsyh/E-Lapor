        ...
        <div class="row" style="row-gap: 2.5rem;">
            <div class="col-md-6 col-lg-3">
                ...
                <div class="d-flex gap-3">
                    <a href="https://www.facebook.com/universitasnuruljadid/" class="d-flex align-items-center justify-content-center rounded-circle" style="width: 36px; height: 36px; background: rgba(255,255,255,0.1); color: #fff; text-decoration: none; transition: background 0.3s;">
                    ...
                    <a href="https://www.instagram.com/unujaofficial/" class="d-flex align-items-center justify-content-center rounded-circle" style="width: 36px; height: 36px; background: rgba(255,255,255,0.1); color: #fff; text-decoration: none; transition: background 0.3s;">
                    ...
                    <a href="https://x.com/unujaofficial" class="d-flex align-items-center justify-content-center rounded-circle" style="width: 36px; height: 36px; background: rgba(255,255,255,0.1); color: #fff; text-decoration: none; transition: background 0.3s;">
                        <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                    </a>
                    <a href="https://www.tiktok.com/@unujaofficial" class="d-flex align-items-center justify-content-center rounded-circle" style="width: 36px; height: 36px; background: rgba(255,255,255,0.1); color: #fff; text-decoration: none; transition: background 0.3s;">
