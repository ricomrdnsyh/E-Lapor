                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-column gap-4">
                                        ...
                                        <div class="d-flex flex-column gap-3">
                                            ...
                                            <div
                                                class="bg-body border border-gray-300 rounded-3 px-4 py-3 hover-elevate-up">
                                                <div class="text-gray-500 fw-bold fs-8 text-uppercase mb-1">Nama Petugas
                                                </div>
                                            ...
                                            <div
                                                ...
                                                <div class="text-gray-900 fw-bold fs-6 text-break">Aktif Sebagai Akun Unit
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end min-w-125px">
                                                <li><a class="dropdown-item"
                                                        onclick="downloadChart('kategoriChart', 'Laporan Per Kategori', 'png')"
                                                        href="javascript:void(0)">PNG</a></li>
                                                <li><a class="dropdown-item"
                                                        onclick="downloadChart('kategoriChart', 'Laporan Per Kategori', 'jpeg')"
                                                        href="javascript:void(0)">JPEG</a></li>
                                                <li><a class="dropdown-item"
                                                        onclick="downloadChart('kategoriChart', 'Laporan Per Kategori', 'pdf')"
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-5">
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end min-w-125px">
                                                    <li><a class="dropdown-item"
                                                            onclick="downloadChart('subKategoriChart', 'Laporan Per Sub Kategori', 'png')"
                                                            href="javascript:void(0)">PNG</a></li>
                                                    <li><a class="dropdown-item"
                                                            onclick="downloadChart('subKategoriChart', 'Laporan Per Sub Kategori', 'jpeg')"
                                                            href="javascript:void(0)">JPEG</a></li>
                                                    <li><a class="dropdown-item"
                                                            onclick="downloadChart('subKategoriChart', 'Laporan Per Sub Kategori', 'pdf')"
                                                            href="javascript:void(0)">PDF</a></li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (subKategoriChartInstance) {
                                ...
                                subKategoriChartInstance.data.datasets[0].data = response
                                    .subValues;
                                subKategoriChartInstance.data.datasets[0].backgroundColor =
                                    response.subLabels.map((_, i) => BAR_COLORS[(i + 3) %
                                        BAR_COLORS.length]);
