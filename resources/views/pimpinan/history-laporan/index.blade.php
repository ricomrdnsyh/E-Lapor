...
@section('content')
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div class="card-body py-4">
                            <div class="filter-container p-6 mb-7">
                                <div class="d-flex align-items-center mb-4">
                                    <i class="ki-duotone ki-filter fs-3 text-primary me-2"><span class="path1"></span><span
                                            class="path2"></span></i>
                                ...
                                <div class="row g-5">
                                    <div class="col-12 col-lg-3">
                                        ...
                                        <select id="filter_unit" class="form-select form-select-sm" data-control="select2"
                                            data-placeholder="Semua Unit" data-allow-clear="true">
                                    ...
                                    <div class="col-12 col-lg-3">
                                        ...
                                        <select id="filter_kategori" class="form-select form-select-sm"
                                            data-control="select2" data-placeholder="Pilih Kategori" data-allow-clear="true"
                                            disabled>
                                            <option value="">Semua</option>
                                            @foreach ($categories as $kat)
                                                <option value="{{ $kat->id_kategori }}"
                                                    data-unit-id="{{ $kat->unit_id ?? '' }}">
                                    ...
                                    <div class="col-12 col-lg-3">
                                        ...
                                        <select id="filter_sub_kategori" class="form-select form-select-sm"
                                            data-control="select2" data-placeholder="Pilih Sub Kategori"
                                    ...
                                    <div class="col-12 col-lg-3">
                                        ...
                                        <select id="filter_status" class="form-select form-select-sm" data-control="select2"
                                    ...
                                    <div class="col-12 col-lg-4">
                                        ...
                                        <select id="filter_gedung" class="form-select form-select-sm" data-control="select2"
                                            data-placeholder="Semua Gedung" data-allow-clear="true">
                                            <option value="">Semua</option>
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="example">
                                    <thead>
                                        <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-150px">Laporan Masuk</th>
            ...
            @include('pimpinan.history-laporan.show')
...
@section('js')
    ...
    @include('pimpinan.history-laporan.script.index')
    @include('pimpinan.history-laporan.script.show')
@endsection
