            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack flex-wrap gap-3">
                    <div class="page-title d-flex flex-column me-3">
                        <h1 class="text-dark fw-bold fs-3 mb-1">History Laporan</h1>
                        <span class="text-muted fw-semibold fs-7">Monitoring riwayat penanganan laporan</span>
                    </div>
                </div>
            </div>
                                ...
                                <div class="px-9 pb-4">
                                    <div class="row g-3">
                                        <div class="col-12 col-md-4">
                                            <label class="fw-bold fs-7 text-gray-800 mb-1 d-block">Gedung:</label>
                                            <select id="filter_gedung"
                                                class="form-select form-select-sm form-select-solid w-100"
                                                data-control="select2" data-placeholder="Semua Gedung"
                                                data-allow-clear="true">
                                                <option value="">Semua</option>
                                                @foreach ($gedungs as $gd)
                                                    <option value="{{ $gd->id_gedung }}">{{ $gd->nama_gedung }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-12 col-md-4">
                                            <label class="fw-bold fs-7 text-gray-800 mb-1 d-block">Kategori:</label>
